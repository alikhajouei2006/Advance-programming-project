        ...
        public static void RemoveSupervisor()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    var answ = AnsiConsole.Ask<string>($"A dormitory supervisor with SocialNumber: {socialnumber} & Name: {data[0]["FullName"]} found. Proceed to supervisor removal? (Y/N) ");
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (role.ToLower() == "student" && db.GetRecordsByField("Students", "SocialNumber", SocialNumber).Count() > 0)
                    {
                        ...
                        {
                            AnsiConsole.MarkupLine("[red]❌ Entered information do not match student's info. Please retry.[/]");
                            Thread.Sleep(3000);
                            continue;
                        }
                    }
        ...
        public static void GetBlockInfo()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    {
                        AnsiConsole.MarkupLine("[red]The entered Block supervisor is assigned to another dormitory ,please try another one ... [/]");
                        Thread.Sleep(3000);
                        continue;
                    }    
                    AnsiConsole.MarkupLine("[red]❌ Responsible not found or is assigned elsewhere. Please try again.[/]");
                    Thread.Sleep(2000);
                }
